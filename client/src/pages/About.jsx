      ...
      <h1 className="text-center text-light d-lg-none">ABOUT</h1>
        ...
        <div className="d-flex justify-content-center">
          <div className="about-content">
            <p className="about-text clearfix text-light p-4">
              ...
              I've been obsessed with coding.
              I started self-learning software development in 2019 when I first tried to build my own e-commerce website. From that time, I found myself deeply passionate on software development. From design to build, from development to production, I exprienced great joy and competence. I will finish my web application development diploma in the year 2022, but I will not stop learning, I enjoy to explore and pick up new frameworks and tools. That's me who will not waste any opportunity to keep learning and exploring the software development.
        ...
        <div className="about-skills py-5">
          ...
          <div className="skill-card row text-center container justify-content-around mx-auto">
            ...
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('react')}>ReactJS</button>
            </div>
            <div className="col p-3">
            ...
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('tailwindcss')}>TailwindCSS</button>
            </div>
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('figma')}>Figma</button>
            </div>
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('milanote')}>Milanote</button>
            </div>
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('photoshop')}>Photoshop</button>
            </div>
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('nodejs')}>NodeJS</button>
            </div>
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('express')}>Express</button>
            </div>
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('mongodb')}>MongoDB</button>
            </div>
            <div className="col p-3">
              <button className="badge rounded-pill" onClick={()=>handleSkill('nextjs')}>NextJS</button>
            </div>
          </div>
        </div>
